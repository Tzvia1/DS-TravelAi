...
def fake_agent(location, interests, note=""):
    ...
    sample = [
        ...
        {"name": "Frishman Beach", "category": "beach",
         "lat": 32.0807, "lon": 34.7665,
         "narration": "Soft sand and sunset views over the Mediterranean."},
        {"name": "Kuli Alma", "category": "bar",
         "lat": 32.0628, "lon": 34.7710,
         "narration": "An artsy late-night bar with murals and music."},
        {"name": "Habima Theatre", "category": "theater",
         "lat": 32.0735, "lon": 34.7795,
         "narration": "Israel's national theatre on a grand plaza."},
        {"name": "Jaffa Hill Lookout", "category": "viewpoint",
         "lat": 32.0823, "lon": 34.7519,
         "narration": "A sweeping view back over the coastline and skyline."},
        {"name": "Levinsky Market", "category": "market",
         "lat": 32.0577, "lon": 34.7745,
         "narration": "Spice stalls, dried fruit, and Balkan delis."},
        {"name": "Tel Aviv Cinematheque", "category": "cinema",
         "lat": 32.0644, "lon": 34.7836,
         "narration": "Art-house films and festivals all year round."},
        {"name": "Great Synagogue of Tel Aviv", "category": "religion",
         "lat": 32.0667, "lon": 34.7706,
         "narration": "A grand 1920s landmark on Allenby Street."},
        {"name": "Meir Garden Playground", "category": "kids",
         "lat": 32.0742, "lon": 34.7740,
         "narration": "A shaded playground in the heart of the city."},
    ]
